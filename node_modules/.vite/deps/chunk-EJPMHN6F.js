...
var FileEmitter = class {
  ...
  finalizeAsset(consumedFile, source, referenceId, { bundle, fileNamesBySource, outputOptions }) {
    ...
    if (!fileName) {
      ...
      if (!fileName || fileName.length > newFileName.length || fileName.length === newFileName.length && fileName > newFileName) {
        if (fileName) {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-4XSC4UW7.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-EJPMHN6F.js.map
