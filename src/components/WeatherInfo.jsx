...
export default function WeatherInfo(){
    ...
    return(
        <section className="w-full h-auto mt-8 flex flex-col gap-4 lg:gap-8 items-center bg-Neutral-900">
            <div className="w-full h-71.5 py-20 px-5 flex flex-col md:flex-row md:items-center justify-center rounded-3xl bg-no-repeat bg-center bg-[url(/assets/images/bg-today-small.svg)]  bg-contain md:bg-[url(/assets/images/bg-today-large.svg)] ">
