...
function Card({title, description,img,isActive}){
    return(
        <div className="w-full border border-Neutral-300 rounded-2xl bg-Neutral-800 p-4 text-Neutral-0">
            ...
            <section className="flex justify-between items-center pt-4">
                ...
                <input type="checkbox" checked={isActive} className="toggle toggle-sm border-0 checked:bg-Red-400" />
            </section>
