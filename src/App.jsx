...
function App () {
  return (
    <main className="w-full h-auto text-lg font-BarlowCondensed">
      <Header />
      <section className="w-auto h-auto my-10 flex flex-col lg:flex-row gap-10 px-[7%] sm:items-center overflow-hidden">
        <img className='lg:order-1 lg:-mr-72' width={800} src="/images/illustration-devices.svg" alt="mainIlustration" />
