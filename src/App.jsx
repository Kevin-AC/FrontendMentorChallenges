...
function App () {
  return (
    <main className="w-full h-auto text-lg font-BarlowCondensed relative z-50 overflow-hidden">
      <div className='z-0 absolute -right-4 lg:-right-32 lg:-top-20 w-3/5 h-96 bg-LightGrayishBlue rounded-b-[40px]'></div>
      <Header />
      <section className="w-auto h-auto my-10 flex flex-col lg:flex-row gap-10 px-[7%] sm:items-center overflow-hidden z-40">
        <img className='lg:order-1 lg:-mr-72 z-40' width={800} src="/images/illustration-devices.svg" alt="mainIlustration" />
        <article className='w-full lg:w-[500px] flex flex-col gap-4 lg:gap-5 '>
