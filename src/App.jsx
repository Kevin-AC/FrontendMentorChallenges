...
function App () {
  ...
  return (
    <main className='w-auto h-auto font-Overpass '>
      <Head />
      <section className='w-full xl:h-screen p-4 xl:my-28 relative overflow-hidden '>
        ...
        <div className='xl:w-4/5 xl:flex xl:justify-center'>
          <picture
            ...
            className=' xl:absolute top-0 -right-56  '
          >
          ...
          <div
            data-aos='fade-right'
            data-aos-duration='1500'
            className='flex flex-col gap-12 mt-16 px-4 xl:mt-0 xl:mr-96 xl:pt-16 xl:w-[520px]'
          >
      ...
      <section className='w-full h-auto xl:h-[430px] z-30 flex flex-col  xl:flex-row  items-center state rounded-tr-[84px] rounded-bl-[84px] pb-28 xl:pb-0 mt-44 xl:mt-0'>
        <img
          data-aos='fade-right'
          data-aos-duration='1500' className='xl:mt-10 -mt-32' src='/assets/images/illustration-phones.svg' alt=''
        />
        <div
          data-aos='fade-left'
          data-aos-duration='1500'
          className='text-center xl:text-left text-White-text mt-9 px-10 xl:px-20  xl:w-2/4  h-auto'
        >
      ...
      <section className='w-full h-screen flex flex-col mt-16  justify-center gap-6 items-center p-4 xl:mt-44 relative'>
        <picture
          data-aos='fade-down'
          data-aos-easing='linear'
          data-aos-duration='1500'
          className=' xl:absolute top-6 -left-56  '
        >
        ...
        <div
          data-aos='fade-left'
          data-aos-duration='1500'
          className='flex flex-col gap-12  xl:ml-96 xl:w-[520px]'
        >
          <Text
